...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/icy-frost-db9a
```

A live public deployment of this template is available at [https://icy-frost-db9a.templates.workers.dev](https://icy-frost-db9a.templates.workers.dev)
